...
namespace Kelime_Ogren
{
    public partial class Form1 : Form
    {
        ...
        OleDbConnection baglanti = new OleDbConnection(@"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=C:\Users\Emre TANER\Documents\GitHub\csharp-25-projects\Kelime_Ogren\dbSozluk.mdb");
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (sure==0)
            {
                ...
                timer1.Stop();
                MessageBox.Show("Süreniz doldu! Toplam bildiğiniz kelime sayısı: " + kelime);
                Application.Exit();
            }
        }
    }
